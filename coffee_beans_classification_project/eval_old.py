# -*- coding: utf-8 -*-
"""
Created on Sun Aug 22 16:47:38 2021
...
from torchvision.models import resnet18,resnet34,resnet50,shufflenet_v2_x1_0,SqueezeNet
...
#model.load_state_dict(torch.load('./oursfinal3.pth'))#使用之前訓練的model
